...
// class CarRentDetailsController extends GetxController {
//   Map<String, dynamic> listCarLocationRent = {};
//   StatusRequest statusRequest = StatusRequest.non;
//   PageController Pcontroller = PageController();
//   List images = [];
//   getImages() {
//     for (var i = 0; i < 3; i++) {
//       images.add(listCarLocationRent['cars_image${i + 1}']);
//     }
//     print(images);
//   }
...
//     super.onInit();
//     listCarLocationRent = Get.arguments['listCarLocationRent'];
//     print("------------------");
//     print(listCarLocationRent);
//     getImages();
//   }
// }
