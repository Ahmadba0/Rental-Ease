...
class RealEstatePOstWaitingMaktab extends StatelessWidget {
  const RealEstatePOstWaitingMaktab({super.key});
...
// }
/*
class CustomListForCity extends GetView<RealestateMaktabPostWaitingController> {
...
class CustomRowRentOrSellRealestate
    extends GetView<RealestateMaktabPostWaitingController> {
