...
import 'package:rental_ease/controller/admin/add_sub_admin_review_controller.dart';
...
class AddSubAdminReview extends StatelessWidget {
  const AddSubAdminReview({super.key});

  @override
  Widget build(BuildContext context) {
    AddSubAdminReviewController controller =
        Get.put(AddSubAdminReviewController());
    return Scaffold(
      appBar: AppBar(
      ...
      body: GetBuilder<AddSubAdminReviewController>(
