...
class CustomManzel extends GetView<HousePageCntroller> {
  const CustomManzel({super.key});
                        ...
                        child: Card(
                          ...
                          child: Column(
                            children: [
                              ...
                              //صورة صك الملكية
                              //
                              CustomImageForSK(), SizedBox(height: 15),
                            ],
                          ),
                        ),
                      ),
