...
class CustomThreeImages extends GetView<HousePageCntroller> {
  const CustomThreeImages({super.key});
    ...
    return Container(
      child: Column(
        children: [
          ...
          //
          //
          controller.selectedOfTypeRealEstat == "مكتب"
              ? Container()
              : Row(
                  children: [
                    Expanded(
                    ...
                    Expanded(
                      child: Stack(
                        children: [
                          ...
                          controller.file9 == null
                              ? Container()
                              : CustomBTNForDelete(
                                  onPressed: () =>
                                      controller.deletefile("file9"),
                                )
                        ],
                      ),
                    ),
