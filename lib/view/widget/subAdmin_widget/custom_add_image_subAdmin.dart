...
class CustomAddImageSubAdmin extends GetView<PrivatePostPageControoler> {
  final void Function()? onTap1;
  final void Function()? onTap2;
  final void Function()? onTap3;
  const CustomAddImageSubAdmin(
            ...
            child: Stack(
              children: [
                ...
                controller.file0 == null
                    ? Container()
                    : CustomBTNForDelete(
                        onPressed: () => controller.deleteFile(0),
                      )
              ],
            ),
          ),
            ...
            child: Stack(
              children: [
                ...
                controller.file1 == null
                    ? Container()
                    : CustomBTNForDelete(
                        onPressed: () => controller.deleteFile(1),
                      )
              ],
            ),
          ),
            ...
            child: Stack(
              children: [
                ...
                controller.file2 == null
                    ? Container()
                    : CustomBTNForDelete(
                        onPressed: () => controller.deleteFile(2),
                      )
              ],
            ),
          ),
