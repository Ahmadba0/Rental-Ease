...
// class CustomListLRWidding extends GetView<HomeController> {
//   const CustomListLRWidding({super.key});
...
//         itemCount: controller.listWiddingLocation.length >= 5
//             ? 5
//             : controller.listWiddingLocation.length,
...
//                       image: NetworkImage(
//                           "${AppLink.image}/${controller.listWiddingLocation[index]['widding_image0']}"),
//                       fit: BoxFit.fill,
//                       width: Get.width - 75,
//                     ),
//                   ),
