...
// class CustomListLRRentCar extends GetView<HomeController> {
//   const CustomListLRRentCar({super.key});
...
//         itemCount: controller.listCarLocationRent.length >= 5
//             ? 5
//             : controller.listCarLocationRent.length,
...
//                       image: NetworkImage(
//                           "${AppLink.image}/${controller.listCarLocationRent[index]['cars_image1']}"),
//                       fit: BoxFit.fill,
//                       width: Get.width - 75,
//                     ),
//                   ),
