...
class GoogleMapWiddingPage extends StatefulWidget {
  const GoogleMapWiddingPage({super.key});

  @override
  State<GoogleMapWiddingPage> createState() => _GoogleMapWiddingPageState();
}

class _GoogleMapWiddingPageState extends State<GoogleMapWiddingPage> {
  @override
  Widget build(BuildContext context) {
    Get.put(WiddingHallController());
    return GetBuilder<WiddingHallController>(
